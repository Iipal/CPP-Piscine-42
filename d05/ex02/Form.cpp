...
Form::FormIsntSigned::FormIsntSigned(void) {}
Form::FormIsntSigned::FormIsntSigned(FormIsntSigned const&) {}
Form::FormIsntSigned::~FormIsntSigned(void) throw() {}

Form::FormIsntSigned &Form::FormIsntSigned::operator=(Form::FormIsntSigned const &copy) { (void)copy; return *this; }

const char *Form::FormIsntSigned::what(void) const throw() { return "Exception: Form isn't signed."; }
